...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const o="videoplayer-current-time",r=document.querySelector("#vimeo-player"),l=new Player(r);function a(e){const t=e.seconds;localStorage.setItem(o,t)}function n(){let e=localStorage.getItem(o);e&&(e=localStorage.getItem(o),l.setCurrentTime(e),l.off("play",n))}l.on("play",n),l.on("timeupdate",(0,e.default)(a,1e3));
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.50446a05.js.map