...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form");a.addEventListener("input",(0,e.default)(n,500)),a.addEventListener("submit",s);const l="feedback-form-state";let r={};function s(e){e.preventDefault();const t=e.target.elements,s=t.email.value,n=t.message.value;return""===n&&""===s?alert('Поля "email" та "message" мають бути заповнені!'):""===s?alert('Поле "email" мають бути заповнені!'):""===n?alert('Поле "message" мають бути заповнені!'):(r={email:s,message:n},console.log(r),a.reset(),void localStorage.removeItem(l))}function n(e){r[e.target.name]=e.target.value,localStorage.setItem(l,JSON.stringify(r))}function o(){let e=localStorage.getItem(l);e&&(e=JSON.parse(e),Object.entries(e).forEach(e=>{let[t,l]=e;r[t]=l,a.elements[t].value=l}))}o();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.b0d17279.js.map